...
class FlagService
{
    private array $countryList = array(
        "Afghanistan" => "AF",
        "Albania" => "AL",
        "Algeria" => "DZ",
        "American Samoa" => "AS",
    ...
    private const base_url = 'https://flagpedia.net/data/flags/w580/';


    public function getFlagByCountry($country): ?string
    {
        $countryCode = strtolower($this->countryList[$country]);

        return self::base_url . $countryCode . '.png';
    }
}
