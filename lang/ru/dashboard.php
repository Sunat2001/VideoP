...
return [
    ...
    'attribute' => [
        ...
        'edit_attribute_value' => 'Редактировать значение атрибута',
        'delete_attribute_value' => 'Удалить значение атрибута',
        'attribute_value_name' => 'Название значения атрибута',
        'attribute_value_image' => 'Изображение значения атрибута',
        'attribute_value_description' => 'Описание значения атрибута',
        'attribute_value_created_at' => 'Время создания значения атрибута',
        'attribute_value_updated_at' => 'Время обновления значения атрибута',
        ...
        'attribute_value_placeholder' => [
            'name' => 'Введите название значения атрибута',
            'image' => 'Выберите изображение',
            'description' => 'Введите описание значения атрибута',
        ],
        'message' => [
